...
def plot_average_pollutants_vs_wind_direction(df):
    ...
    # Menghapus baris dengan nilai NaN di kolom 'wd_deg'
    df = df.dropna(subset=['wd_deg', 'PM2.5', 'PM10', 'SO2', 'NO2', 'CO', 'O3'])
    ...
    # Create scatter plots for each pollutant against wind direction
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='PM2.5', label='PM2.5', marker='o')
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='PM10', label='PM10', marker='o')
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='SO2', label='SO2', marker='o')
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='NO2', label='NO2', marker='o')
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='CO', label='CO', marker='o')
    sns.scatterplot(data=average_pollutants, x='wd_deg', y='O3', label='O3', marker='o')
